        ...
        <>
            <section className="relative bg-[#a3d9ff] pt-2 dark:bg-dusk-gradient overflow-hidden snap-start">
                <div className="relative z-30 md:translate-x-1/4  text-center px-4 md:pr-72 md:pt-6 pb-32">
                    ...
                    >{theme === 'dark' ? <Image src="/cloud3.png" alt="cloud" width={100} className="left-10 shadow-md-darktextSecondary" height={100} /> : <><Image src="/cloud2.png" alt="cloud" width={100} className="left-10" height={100} /> <Image src="/cloud.png" alt="cloud" width={50} className="right-10" height={100} /></>}
